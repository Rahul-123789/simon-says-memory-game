...
| 🇧🇷 PT-BR                                                                                                                                                                                                                                                                                                                                                                                                                                          | 🇺🇸 EN                                                                                                                                                                                                                                                                                                                                                                                                                    |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Clone o repositório:<br>`bash<br>git clone https://github.com/Joaolbero/simon-says-memory-game.git<br>`<br>2. Entre na pasta do projeto:<br>`bash<br>cd simon-says-memory-game/src/simon-says-memory-game<br>`<br>3. Abra o arquivo `index.html` diretamente no navegador **ou** utilize uma extensão de Live Server no VS Code.<br>4. Certifique-se de que as pastas `assets/` e `audio/` estejam com os arquivos PNG e MP3 nos nomes corretos. | 1. Clone the repository:<br>`bash<br>git clone https://github.com/Joaolbero/simon-says-memory-game.git<br>`<br>2. Enter the project folder:<br>`bash<br>cd simon-says-memory-game/src/simon-says-memory-game<br>`<br>3. Open `index.html` directly in your browser **or** use a Live Server extension in VS Code.<br>4. Make sure the `assets/` and `audio/` folders contain the PNG and MP3 files with the correct names. |
...
| 🇧🇷 PT-BR | 🇺🇸 EN |
| --- | --- |
| - Adicionar atalhos de teclado para os pads (Q, W, A, S, por exemplo).<br>- Ranking global via backend/API.<br>- Sistema de conquistas (ex.: “Chegou ao nível 20 no Expert”).<br>- Tela de configurações com controle de volume e tempo de animação customizável.<br>- Versão mobile “full screen” para jogar tocando na tela. | - Add keyboard shortcuts for the pads (e.g. Q, W, A, S).<br>- Global ranking via backend/API.<br>- Achievement system (e.g. “Reached level 20 on Expert”).<br>- Settings screen with volume slider and customizable animation timings.<br>- Mobile “full screen” version for touch play. |
